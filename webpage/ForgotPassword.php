...
if(isset($_POST['PasswordSend']))
{
    if($connection==1)
    {
        ...
        {
            $command="Select * from applicant WHERE Email='$Email'";
            $m=$con->query($command);
...
//                $command2="Insert into tokens(Email,Value,Type) values('$Email','$code','$Type2')";
                            ...
                            $message2="<h2>Dear ".$data['FirstName']." ".$data['LastName']."</h3><br><h3>please click the link given below to change the password.</h3><br><a href='http://www.telpherpoint.com/nvv/webpage/SetNewPassword.php?data=$Email'>Link Reset Password</a>";
