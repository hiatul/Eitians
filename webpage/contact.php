...
<body>
  ...
  <li>Contact</li>
        ...
        <p style="font-family:global4;font-size: 50px;position: relative;padding: 0;margin: 0;color:#fff;">Contact</p>
</div>
...
<div class="col-12" style="background-color: #ccc;height: 50%;">
    ...
    <div class=" col-12" style="color: #fff;background-color:#f9f9f9;text-align:center;text-align: justify;font-family: global6; ">
        ...
        <form  >
            ...
            <input type="text" class="col-9 textbox" value="<?php echo @$_SESSION['FirstName']." ".@$_SESSION['LastName'];?>">
        <p class="formText">Your e-mail address *</p>
        <input type="text" class="col-9 textbox" value="<?php echo @$_SESSION['Email'];?><?php echo @$_SESSION['OEmail'];?>">
        <p class="formText">Subject *</p>
        <input type="text" class="col-9 textbox">
        <p class="formText">Message *</p>
        <textarea class="col-9 textbox" style="height: 80px;"></textarea><br><br>
        
        <input type="submit" class="textbox cursor" style="float: none;" value="Send message">
        </form>
    </div>
