...
if(!isset($_SESSION)) 
    ...
    if(isset($_GET['ApplyNow']))
    {
        ...
        else
        {
            ...
            $Rid=$_GET['Rid'];
            $Jid=$_GET['Jid'];
            $command2="Select Id,Jid from applicantapplied where Jid=$Jid AND Id=$Id";
            $result=$con->query($command2);
                ...
                {    
                        ...
                        $command="Insert into applicantapplied(Id,Rid,Jid,ApplyDate) values($Id,$Rid,$Jid,'$date')";
                    ...
                    <div class="col-12" style="height: auto;padding-top: 0px;padding-top: 10px;">
                      <?php          
                       if(!isset($_SESSION)) 
                              ...
                              if($connection==1)
                                       {      $command="Select Title,Location,Category,Type,Experience,Salary,Tags,Description,Deadline,Shift,JobSpec,TechGuide,Logo,Rid,Jid,DATE(PostDate) AS PostDate from  jobpost WHERE Jid=$Jid and Rid=$Rid";
